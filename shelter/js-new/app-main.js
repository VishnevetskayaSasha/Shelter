...
//создаем экземпляр компонента слайдера
const slider =  Slider.createComponent(PetsJSON);

//добавляем созданный слайдер в нужную секцию
document.querySelector(".our-friends").append(slider);
