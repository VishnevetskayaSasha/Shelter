...
import { createComponent } from "./components/showcase/showcase.js";

const pagination = createComponent(PetsJSON);
document.querySelector(".our-friends").append(pagination);
